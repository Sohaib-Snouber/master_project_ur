...
public:
          ...
          wheel_position_(0.0)
    {
        ...
        joint_state_msg_.name = {"front_left_wheel", "front_right_wheel", "rear_left_wheel", "rear_right_wheel"};
        joint_state_msg_.position = {wheel_position_, wheel_position_, wheel_position_, wheel_position_};
    }
...
private:
    void update_joint_state()
    {
        ...
        joint_state_msg_.position[1] += 0.10; // front_left_wheel
        joint_state_msg_.position[2] += 0.10; // front_right_wheel
        joint_state_msg_.position[3] += 0.10; // rear_left_wheel
        joint_state_msg_.position[4] += 0.10; // rear_right_wheel
