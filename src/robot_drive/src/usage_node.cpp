...
private:
    ...
    bool moveTo(const geometry_msgs::msg::PoseStamped& target_pose, bool constrain, bool motion_speed) {
...
// 2- bool reconnect()
// 3- bool isConnected()
// 4- bool sendCustomScriptFunction(const std::string &function_name, const std::string &script)
// 5- 
